...
| Inbound client intake sheet | Evermore operator + Agent Suite backend | `inbound-client-intake/index.html`, `agent-suite-intake-continuity.js`, and live route `https://evermorelife.org/inbound-client-intake/` |
