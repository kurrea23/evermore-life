...
for must in "index.html" "growth-calculator/index.html" "score-tracker/index.html" "today/index.html" "clients/index.html" "inbound-client-intake/index.html" "agent-suite-auth.js" "agent-suite-intake-continuity.js" "agent-suite-ui.css" "agent-suite-icons.js" "agent-suite-activity.js" "CNAME"; do
